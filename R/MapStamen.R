...
MapStamen <- R6Class("MapStamen",
                     public = list(
                       ...
                       #' Saves a png file in the working directory.
                       saveMap = function(){
                     ...
                     bubble = function() {
                       ...
                       unhealthy <- data.frame("Somewhat Unhealthy" = data5$Unhealthy.for.Sensitive.Groups, 
                                               "Unhealthy" = data5$Unhealthy, "Very Unhealthy" = data5$Very.Unhealthy, 
                       ...
                       plot1 = ggplot(data = goodplot, mapping =  aes(x = latit, y = longi, size = gooddays)) + 
                       ...
                       plot2 = ggplot(data = goodplot, mapping =  aes(x = latit, y = longi, size = moderatedays)) + 
                       ...
                       plot3 = ggplot(data = goodplot, mapping =  aes(x = latit, y = longi, size = nothealthy)) + 
